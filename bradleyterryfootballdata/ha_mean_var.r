...
tie_betas0.7sigma0.7pho = PGSmootherPost_tie(0,10000,0,0,win.matrix,draw.matrix,total.matrix,0.7,0.7,index_list_matrix, 0.5)
means_over_time0.7sigma0.7_ha = matrix(0,8, 10)
tie_means0.7sigma0.7pho = matrix(0,8, 10)
tie_betas0.7sigma0.7pho_thin = tie_betas0.7sigma0.7pho_thin[seq(1, 10000, 2)]
for (j in 1 : 10){
  GGGG = matrix(0, 4900,8)
